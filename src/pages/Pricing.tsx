  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: t("Contains ads (upgrade to remove)", "Contient des publicités (upgrade pour supprimer)", "Contiene anuncios (actualiza para eliminar)", "Contém anúncios (atualize para remover)", "含有广告（升级以移除）", "يحتوي على إعلانات (قم بالترقية لإزالتها)", "Contiene pubblicità (aggiorna per rimuovere)", "Enthält Werbung (Upgrade zum Entfernen)", "Bevat advertenties (upgrade om te verwijderen)", "Содержит рекламу (обновите для удаления)", "広告あり（アップグレードで削除）"), included: false },
      ],
    },
    {
      id: "pro",
